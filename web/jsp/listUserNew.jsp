            ...
            colModel: [
                {
                    ...
                    formatoptions: {
                        ...
                        //删除按钮
                        delOptions: {recreateForm: true, beforeShowForm: beforeDeleteCallback,url:"/webServer/user/del"},
...
//                {name:'note',index:'note', width:150, sortable:false,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"10"}}
            ...
            editurl: "/webServer/user/update",//nothing is saved
            caption: "人员信息",
...
//            var gr = $(grid_selector).jqGrid('getGridParam','selrow');
//            if(gr){
//                var rowData = $(grid_selector).jqGrid("getRowData", gr);
//                $(grid_selector).jqGrid('delGridRow', gr ,{
//                    top: 100,
//                    left: 400,
...
//        });
        ...
        jQuery(grid_selector).jqGrid('navGrid', pager_selector,
                ...
                { url: '/webServer/user/update', mtype: 'GET'},
                { url: '/webServer/user/add', mtype: 'GET'},
                { url: '/webServer/user/del', mtype: 'GET'},
                {
                    //edit record form
                    //closeAfterEdit: true,
                    //width: 700,
